...
make clean -C ../aggregate_robinhood_murmur/
make -C ../aggregate_robinhood_murmur/
...
for skew in 0; do
	...
	#	make logGroups=${logGroupSize} -C ../aggregate_robinhood_mult/	
		...
		/fastdisk/aggregate_robinhood_murmur/aggregate /slowdisk/$size/$skew/data_${groupSize}.tbl 40 $groupSize $numOfTuples &>> $1/raw_results_${size}_${skew}.txt
